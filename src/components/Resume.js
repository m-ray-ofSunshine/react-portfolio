function Resume() {
    ...
    return (
        ...
        style={{
            ...
            <a href="https://drive.google.com/file/d/157HIt4XCW6OWbrxSLGEoaU9v2KO86Nyd/view?usp=sharing" target="_blank" alt="link to pdf"><button id="newTab" type="button" className="m-2 w-50 btn btn-primary" >Open in a new tab</button></a>
